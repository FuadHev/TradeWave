...
interface ProductRepository {
    ...
    suspend fun getCards():Flow<Resource<List<CardUiModel>>>
    fun addCard(card:CardUiModel): Flow<Resource<Boolean>>
    fun deleteCard(card:CardUiModel): Flow<Resource<Boolean>>
